...
description: Angemeldeten Benutzer bzw. IP-Adresse & Referrer mitschicken
...
In den Formular-Einstellungen gibt es zwei Checkboxen unter **„Automatisch mitgesendete
...
Entwickler-Seite in dieser Hilfe) aufgenommen werden. Standardmäßig sind beide deaktiviert.
...
- **IP-Adresse & Referrer mitschicken**: die IP-Adresse des Absenders sowie die
  Referrer-URL beim Absenden (i. d. R. die Seite, auf der das Formular liegt - nicht
  zwingend die ursprüngliche Anzeige/Quelle, falls der Besucher vorher schon auf der
